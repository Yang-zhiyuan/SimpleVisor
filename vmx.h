...
enum vmx_msr
{
    MSR_IA32_VMX_BASIC_INDEX,
    MSR_IA32_VMX_PINBASED_CTLS_INDEX,
    MSR_IA32_VMX_PROCBASED_CTLS_INDEX,
    MSR_IA32_VMX_EXIT_CTLS_INDEX,
    MSR_IA32_VMX_ENTRY_CTLS_INDEX,
    MSR_IA32_VMX_MISC_INDEX,
    MSR_IA32_VMX_CR0_FIXED0_INDEX,
    MSR_IA32_VMX_CR0_FIXED1_INDEX,
    MSR_IA32_VMX_CR4_FIXED0_INDEX,
    MSR_IA32_VMX_CR4_FIXED1_INDEX,
    MSR_IA32_VMX_VMCS_ENUM_INDEX,
    MSR_IA32_VMX_PROCBASED_CTLS2_INDEX,
    MSR_IA32_VMX_EPT_VPID_CAP_INDEX,
    MSR_IA32_VMX_TRUE_PINBASED_CTLS_INDEX,
    MSR_IA32_VMX_TRUE_PROCBASED_CTLS_INDEX,
    MSR_IA32_VMX_TRUE_EXIT_CTLS_INDEX,
    MSR_IA32_VMX_TRUE_ENTRY_CTLS_INDEX,
};
...
// This header defines the externally visible structuresand functions of the
// Simple Hyper Visor which are visible between the OS layerand SimpleVisor.
